...
unsigned int network_encode(char* encode_string,unsigned int encode_string_length_) {
    ...
    char* encode_buffer=new char[encode_buffer_length];//(char*)malloc(encode_buffer_length);
    ...
    delete encode_buffer;//free(encode_buffer);
...
void network_decode(char* decode_string,unsigned int decode_string_length_) {
    ...
    char* decode_buffer=new char[decode_buffer_length];//(char*)malloc(decode_buffer_length);
    ...
    delete decode_buffer;//free(decode_buffer);
}
